          ...
          <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6">
              <div class="item_f1">
                ...
                <a href="html-items/cursus_main_demo/our_blog.html">Blog</a>
                <a href="html-items/cursus_main_demo/career.html">Careers</a>
                <a href="html-items/cursus_main_demo/press.html">Press</a>
              </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
              <div class="item_f1">
                <a href="html-items/cursus_main_demo/help.html">Help</a>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6">
              <div class="item_f1">
                ...
                <a href="html-items/cursus_main_demo/terms_of_use.html"
                  >Privacy Policy</a
                >
                <a href="html-items/cursus_main_demo/sitemap.html">Sitemap</a>
              </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
              <div class="item_f3">
                ...
                <div class="lng_btn">
                  ...
                  >
                    <a href="#"
                      ><i class="uil uil-globe lft"></i>Language<i
                        class="uil uil-angle-down rgt"
                      ></i
                    ></a>
                    <div class="menu">
                      ...
                      <li>
                        <a href="index.html">
                          <div class="footer_logo">
                            <img
                              src="html-items/cursus_main_demo/images/logo1.svg"
                              alt=""
                            />
                          </div>
                        </a>
